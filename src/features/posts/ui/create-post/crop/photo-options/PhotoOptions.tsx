...
export const PhotoOptions = ({
    ...
    return (
        <>
            <CropPanel aspectRatio={aspectRatio} getAspectRatio={getAspectRatio} cropPanelVisible={cropPanelVisible} />
            ...
            <ImgBtn
                ...
                icon={<SvgExpand className={styles.uploadIcon} />}
                onClick={handleCropPanelVisible}
            />

            <ImgBtn
                className={styles.uploadBtn}
                icon={<SvgImage className={styles.uploadIcon} />}
                onClick={handleUploadPanelVisible}
            />
        </>
    );
};
